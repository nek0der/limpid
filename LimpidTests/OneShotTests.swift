// OneShotTests.swift
// First-call-wins semantics for the Sparkle reply / acknowledgement
// wrapper. Sparkle's contract is that each callback fires exactly
// once — forgetting stalls the updater, doubling asserts — so the
// OneShot wrapper is load-bearing for the update pipeline.
