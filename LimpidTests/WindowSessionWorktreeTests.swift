...
// Exercises the worktree create / delete pipelines in
// WindowSession+Worktree against a scripted `FakeGit`. This unblocks
// the largest untested module in the project (424 LOC) without
// shelling out to a real `git` per test.
//
