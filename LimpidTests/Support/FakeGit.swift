// FakeGit.swift
// Scripted `GitRunning` implementation for tests. Each call records its
// arguments and returns a pre-canned `GitResult`. The test decides
// whether to script success, a generic failure, or one of the typed
// stderr patterns the worktree pipeline branches on.
