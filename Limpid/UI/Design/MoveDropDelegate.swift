...
let limpidDragLog = Logger(subsystem: "dev.limpid", category: "sidebar.drag")
...
extension View {
    ...
    /// 1x1 transparent rect to 40x24 — macOS 26 also refuses to begin
...
final class LimpidDragState {
    enum Kind { case group, worktree, tab, project }
