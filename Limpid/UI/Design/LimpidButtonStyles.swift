...
// Limpid — shared button modifiers:
...
extension View {
    /// Pill-shaped subtle background used by sidebar/tab-bar toolbar
    ...
    func limpidToolbarButton(cornerRadius: CGFloat = 8) -> some View {
        modifier(LimpidToolbarButtonModifier(cornerRadius: cornerRadius))
    }
}

private struct LimpidToolbarButtonModifier: ViewModifier {
