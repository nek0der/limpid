...
//
// We filter scalar-by-scalar in a single pass and deliberately
// preserve ZWNJ (U+200C) / ZWJ (U+200D) for emoji and Arabic/Persian
// ligatures, which a naive regex-range filter drops.
