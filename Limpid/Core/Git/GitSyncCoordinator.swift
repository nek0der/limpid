...
private let log = Logger(subsystem: "dev.limpid", category: "git.sync")
...
private final class ProjectSync {
    ...
    private func refetch() async {
        ...
        // Main checkout entry is captured separately for the chrome
    ...
    /// Materialise a `Worktree` from a `GitWorktreeInfo`, optionally
    ...
    private func mergeWorktree(
        ...
        // sources happen to be empty (e.g. a freshly initialised
    ...
    /// L2/L3 chrome subtitle when the project container is active.
