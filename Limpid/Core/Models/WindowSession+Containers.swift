...
// reorder helpers, top-level cross-container reorder, and the L1
...
extension WindowSession {
    ...
    //
    // Centralised so views don't have to walk the arrays themselves.
    ...
    /// Restoring it returns the L1 (groups / projects), L2 (tabs), and
